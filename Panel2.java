...
{
	public ArrayList<Integer> sampleX1;
	public ArrayList<Long> sampleY1;
	public ArrayList<Integer> sampleX2;
	public ArrayList<Long> sampleY2;
	public ArrayList<Integer> sampleX3;
	public ArrayList<Long> sampleY3;
	
	public Panel2()
	{
		sampleX1 = new ArrayList<Integer>();
		sampleY1 = new ArrayList<Long>();
		sampleX2 = new ArrayList<Integer>();
		sampleY2 = new ArrayList<Long>();
		sampleX3 = new ArrayList<Integer>();
		sampleY3 = new ArrayList<Long>();
	}
    ...
    public int findXInterval()
    {
        ...
        //Maximum is always either in the beginning or at the end of the array "sample."
    	for(int i=0;i<sampleX1.size();i++)
    	{
